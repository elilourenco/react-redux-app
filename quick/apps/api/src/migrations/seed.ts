...
function img(id: number, size = 1200) {
  // Lista de IDs conhecidos como válidos
  const validIds = [1, 10, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000];
  const selectedId = validIds[id % validIds.length];
  return `https://picsum.photos/id/${selectedId}/${size}/${size}`;
}
